...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            comandi::pdf_protetto,
            comandi::proteggi_pdf,
            comandi::sblocca_pdf,
            comandi::esporta_immagini,
            comandi::crea_pdf_da_immagini,
            comandi::numera_pagine,
            comandi::redigi,
            comandi::ottimizza,
            comandi::esporta_contenuto,
            comandi::compila_modulo,
            comandi::esporta_dati_form,
            comandi::salva_testo,
            comandi::batch,
            comandi::ritaglia_pagine,
            comandi::inserisci_pagine,
            comandi::stampa_unione,
            comandi::ai_riassumi,
            comandi::ai_domanda,
            comandi::ai_traduci,
            comandi::annota,
            comandi::riepilogo_annotazioni,
            comandi::ricerca_multi,
            comandi::genera_toc,
            comandi::esporta_docx,
            comandi::esporta_xlsx,
            comandi::comprimi_immagini,
            comandi::auto_correggi,
            comandi::sanitizza_pdf,
